...
//
#define CUSTOM_MACHINE_NAME "Tornado-iPark"
...
#define Z_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.lse
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 415 }//fb { 80, 80, 1600, 93 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 1.5, 25 }//fb
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 50, 10000 }//fb
...
// :[-1, 1]
#define X_HOME_DIR  1 //fb
#define Y_HOME_DIR  -1//fb
#define Z_HOME_DIR  -1
